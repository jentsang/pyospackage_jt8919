#
# pyospackage_jt8919 documentation build configuration file
#
import os
import sys
...
# built documents.
try:
    version = importlib.metadata.version("pyospackage_jt8919")
...
htmlhelp_basename = "pyospackage_jt8919_doc"
